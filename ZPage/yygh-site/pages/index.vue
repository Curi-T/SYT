    ...
    <div class="home page-component">
        ...
        <div class="bottom">
            <div class="left">
                ...
                <div v-for="(item, index) in list" :key="index" class="v-scroll-list hospital-list space
                    ">
                    <div class="v-card clickable list-item">
                        <div class="">
                            <div class="hospital-list-item hos-item" @click="show(item.hoscode)" index="0">
                                ...
                                <img :src="'data:image/jpeg;base64,' + item.logoData" :alt="item.hosname"
                                    class="hospital-img">
            ...
            <div class="right">
                <div class="common-dept">
                    ...
                    <div class="content-wrapper">
                        <span class="item v-link clickable dark">神经内科
                        </span>
                        <span class="item v-link clickable dark">消化内科
                        </span>
                        <span class="item v-link clickable dark">呼吸内科
                        </span>
                        <span class="item v-link clickable dark">内科 </span>
                        <span class="item v-link clickable dark">神经外科
                        </span>
